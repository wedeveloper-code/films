...
<main class="site-content" id="main" role="main">
    <div class="auth-wrap">
        <div class="auth-card">
            ...
            <h1 class="auth-title"><?php esc_html_e('Регистрация', 'kinobase'); ?></h1>

            <?php if (!get_option('users_can_register')) : ?>
            <div class="auth-alert auth-alert-error" role="alert">
                <?php esc_html_e('Регистрация на сайте временно отключена.', 'kinobase'); ?>
            </div>
            ...
            <form class="auth-form" method="post"
                ...
                <div class="auth-field">
                    <label class="auth-label" for="kb-username">
                        <?php esc_html_e('Имя пользователя', 'kinobase'); ?>
                    </label>
                    <input type="text" id="kb-username" name="kb_username"
                           ...
                           required autofocus>
                    <p class="auth-hint">
                        <?php esc_html_e('Латинские буквы, цифры, символы: _ - @ . Минимум 3 символа.', 'kinobase'); ?>
                    </p>
                </div>
                ...
                <div class="auth-field">
                    ...
                    <input type="email" id="kb-email" name="kb_email"
                           ...
                           required>
                    <p class="auth-hint">
                        <?php esc_html_e('На этот адрес придёт ссылка для подтверждения и данные для входа.', 'kinobase'); ?>
                    </p>
                </div>

                <button type="submit" class="auth-submit">
                    <?php esc_html_e('Создать аккаунт', 'kinobase'); ?>
                </button>
            </form>
            <?php endif; ?>
            ...
            <div class="auth-links">
                <span><?php esc_html_e('Уже есть аккаунт?', 'kinobase'); ?></span>
