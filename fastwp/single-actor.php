...
while (have_posts()) :
    ...
    <main class="site-content" id="main" role="main">
        ...
        <div class="single-movie single-actor">
            ...
            <nav class="single-breadcrumb" aria-label="<?php esc_attr_e('Хлебные крошки', 'fastwp'); ?>">
                ...
                <a href="<?php echo esc_url(get_post_type_archive_link('actor')); ?>"><?php esc_html_e('Актёры', 'fastwp'); ?></a>
                <span aria-hidden="true">›</span>
            ...
            <div class="single-layout">
                ...
                <div class="single-info-col">
                    ...
                    <table class="single-meta-table actor-chars-table">
                        <tbody>
                        <tr>
                            <td class="smeta-label"><?php esc_html_e('На сайте с', 'fastwp'); ?></td>
                    ...
                    <div class="single-description">
                        <h3 class="single-section-label"><?php esc_html_e('Биография', 'fastwp'); ?></h3>
                    ...
                    <div class="actor-social">
                        <h3 class="single-section-label"><?php esc_html_e('Социальные сети', 'fastwp'); ?></h3>
            ...
            <section class="actor-filmography">
                <div class="section-header">
                    <h2 class="section-title"><?php esc_html_e('Фильмография', 'fastwp'); ?></h2>
                </div>
    ...
    <div class="kb-lightbox" id="kb-lightbox" role="dialog" aria-modal="true"
         aria-label="<?php esc_attr_e('Просмотр фото', 'fastwp'); ?>">
