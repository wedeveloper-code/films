...
function kb_auth_settings_page(): void
{
    ...
    ?>
    <div class="wrap">
        <h1><?php esc_html_e('Настройки регистрации', 'fastwp'); ?></h1>
        ...
        <form method="post">
            ...
            <table class="form-table">
                <tr>
                    <th><?php esc_html_e('Подтверждение по email', 'fastwp'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="kb_auth_require_confirm" value="1"
                                <?php checked($require); ?>>
                            <?php esc_html_e('Требовать подтверждение email перед созданием аккаунта', 'fastwp'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Снимите галочку, если почтовые отправки не работают — пользователи будут созданы сразу.', 'fastwp'); ?>
                        </p>
                    </td>
                </tr>
            </table>
