...
// Active filter terms (e.g. [2020, action] on /category/films/2020/action/)
$kb_filter_terms = $is_cat ? kb_get_active_filter_terms() : [];
    ...
    <div class="container">
        ...
        <div class="catalog-heading">
            ...
            <div class="catalog-heading-row">
                <div class="catalog-heading-left">
                    <h1 class="catalog-title">
                        <?php
                        if ($is_cat) {
                            echo esc_html(kb_cat_h1($queried, $kb_filter_terms));
                        } else {
                            the_archive_title();
                        }
                        ?>
                        ...
                        <?php echo esc_html(_n('фильм', 'фильмов', $count, 'fastwp')); ?></span>
                        <?php endif; ?>
                    </h1>
                    <?php
            ...
            <div class="filter-bar">
                <?php fastwp_render_desktop_filter_bar($active_url, $reset_url, $is_cat ? $queried : null); ?>
            </div><!-- .filter-bar -->
            <?php endif; ?>
                ...
                <article class="movie-card card-goto">
                    <a href="<?php echo esc_url($next_url); ?>" class="card-goto-link">
                        <div class="card-goto-inner">
                            ...
                            <div class="card-goto-text"><?php esc_html_e('Следующая страница', 'fastwp'); ?></div>
                        </div>
                    </a>
                </article>
                <?php endif; ?>
        ...
        <?php else : ?>
            <div class="no-results">
                <h2><?php esc_html_e('Фильмов не найдено', 'fastwp'); ?></h2>
                <p><?php esc_html_e('В этой категории пока нет фильмов.', 'fastwp'); ?></p>
            </div>
        <?php endif; ?>
