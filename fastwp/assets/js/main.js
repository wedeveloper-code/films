...
(function () {
    ...
    if (cfg.themeAutoTime) {
        setInterval(function () {
            if (localStorage.getItem('fastwp_theme')) return; // manual override wins
            var h  = new Date().getHours();
            var df = parseInt(cfg.themeDarkFrom,  10) || 20;
            var lf = parseInt(cfg.themeLightFrom, 10) || 8;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function applyTheme(dark) {
        ...
        if (dark) {
            ...
            localStorage.setItem('fastwp_theme', 'dark');
            if (themeIcon) themeIcon.textContent = '🌙';
        } else {
            html.classList.remove('dark');
            localStorage.setItem('fastwp_theme', 'light');
    ...
    /* ============================================================
       ...
       ============================================================ */
    if (typeof FastWP === 'undefined') return;
    ...
    var observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
            ...
            var fd = new FormData();
            fd.append('action', 'fastwp_increment_views');
            fd.append('post_id', postId);
            fd.append('nonce', FastWP.nonce);

            fetch(FastWP.ajaxUrl, { method: 'POST', body: fd, credentials: 'same-origin' })
    ...
    if (contactForm && typeof FastWP !== 'undefined') {
        ...
        contactForm.addEventListener('submit', function (e) {
            ...
            var fd = new FormData();
            fd.append('action',           'fastwp_contact');
            fd.append('nonce',            FastWP.contactNonce);
    ...
    if (reviewForm && typeof FastWP !== 'undefined') {
        ...
        reviewForm.addEventListener('submit', function (e) {
            ...
            fd.append('action', 'fastwp_review');
