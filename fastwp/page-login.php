...
<main class="site-content" id="main" role="main">
    <div class="auth-wrap">
        <div class="auth-card">
            ...
            <h1 class="auth-title"><?php esc_html_e('Вход', 'fastwp'); ?></h1>
            ...
            <form class="auth-form" method="post"
                ...
                <div class="auth-field">
                    <label class="auth-label" for="kb-login">
                        <?php esc_html_e('Логин или Email', 'fastwp'); ?>
                    </label>
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-wrap">
                        ...
                        <button type="button" class="auth-toggle-pw"
                                aria-label="<?php esc_attr_e('Показать/скрыть пароль', 'fastwp'); ?>"
                ...
                <label class="auth-remember">
                    ...
                    <?php esc_html_e('Запомнить меня', 'fastwp'); ?>
                </label>
            ...
            <div class="auth-links">
                <a href="<?php echo esc_url(wp_lostpassword_url(home_url('/'))); ?>">
                    <?php esc_html_e('Забыли пароль?', 'fastwp'); ?>
                </a>
