    ...
    <div class="container">
        ...
        <div class="catalog-heading">
            <h1 class="catalog-title">
                <?php esc_html_e('Избранное', 'fastwp'); ?>
                <?php if (!empty($fav_ids)) : ?>
                <span class="catalog-count">
                    — <strong><?php echo count($fav_ids); ?></strong>
                    <?php echo esc_html(_n('фильм', 'фильмов', count($fav_ids), 'fastwp')); ?>
                </span>
                <?php endif; ?>
            </h1>
        </div>
        ...
        <?php if (empty($fav_ids)) : ?>
            ...
            <div class="favorites-empty">
                ...
                <h2 class="favorites-empty-title"><?php esc_html_e('Список избранного пуст', 'fastwp'); ?></h2>
                <p class="favorites-empty-text">
                    <?php esc_html_e('Нажмите на сердечко ♥ на карточке фильма, чтобы добавить его сюда.', 'fastwp'); ?>
                </p>
                <a href="<?php echo esc_url(home_url('/')); ?>" class="favorites-back-btn">
                    <?php esc_html_e('Перейти в каталог', 'fastwp'); ?>
                </a>
            </div>
        ...
        <?php else :
            ...
            <div class="no-results">
                <h2><?php esc_html_e('Фильмы не найдены', 'fastwp'); ?></h2>
                <p><?php esc_html_e('Некоторые фильмы из избранного были удалены с сайта.', 'fastwp'); ?></p>
            </div>
            <?php endif; ?>
